...
Página pública tipo vitrina digital para **Vendedor SCZ**, creada para mostrar productos, pelucas y extensiones, promociones, ubicación, enlaces rápidos de WhatsApp y contenido visual con inteligencia artificial desde Santa Cruz de la Sierra.
...
| Página | Función |
|---|---|
| `index.html` | Portada principal de marca, noticia comercial y accesos rápidos |
...
| `contacto.html` | WhatsApp, ubicación, Google Maps, Waze y mensajes prediseñados |
...
5. Añadir enlaces a Facebook, TikTok y YouTube.
